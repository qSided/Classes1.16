...
public class SoldierSubclassesSelector extends ClassesMod.GuiElement {
	...
	public SoldierSubclassesSelector(ClassesMod instance) {
		super(instance, 1);
		guiElements.addNetworkMessage(ButtonPressedMessage.class, ButtonPressedMessage::buffer,
				ButtonPressedMessage::new, ButtonPressedMessage::handler);
		guiElements.addNetworkMessage(GUISlotChangedMessage.class, GUISlotChangedMessage::buffer,
